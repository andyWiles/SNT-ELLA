...
\newcommand \remarque[3]{
     ...
     \draw[color=black,ultra thick, fill=#1](0,0) circle (7);
        {\clip (0,0) circle (12);
...
\rfoot{ \includegraphics[width=1.8cm]{by-nc-sa.eu.eps} }
...
\begin{flushright} \includegraphics[width=4cm] {fig1-satellites.eps} \end{flushright}
\end{minipage}
